...
4. **Fase 4 (SOM Clustering & Visualization)**: Pengelompokan fitur semantik hasil inferensi ke dalam grid 2D menggunakan *Self-Organizing Maps* (SOM). Struktur hubungan logis antar-variabel medis dianalisis secara visual memanfaatkan fitur **Component Planes**.
